...
try{
	...
	ResultSet rs3 = stmnt3.executeQuery("SELECT * FROM orderdetails o1 JOIN (SELECT custid, MAX(orderid) orid FROM orderdetails WHERE custid=" + custid + " GROUP BY custid) o2 ON o1.custid=o2.custid AND o1.orderid=o2.orid");
	if(rs3.next()){
	...
	ResultSet rs4 = stmnt4.executeQuery("SELECT * FROM orderdetails WHERE orderid=" + orderid);
	while(rs4.next()){
		shipAddress=rs4.getString(2);
	}
