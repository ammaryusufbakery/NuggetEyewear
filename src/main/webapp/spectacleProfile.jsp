...
<body>
 <!-- Header Section -->
    ...
    <form action="AddSpecProfile" method="post">
    
    
    
     <h1>Add New Spectacle Profile</h1>
    ...
    <input type="number" id="eyePowerLeft" name="eyePowerLeft" placeholder="Left" step="0.01" required>

    <label for="eyePowerRight">Eye Power (Right)</label>
    <input type="number" id="eyePowerRight" name="eyePowerRight" placeholder="Right" step="0.01" required>
